...
export default function Card({ data, setIsOpenM, setShow }) {
  ...
  return (
    data && data.date ? <div classNameName="rounded-md p-1.5  text-gray-300 text-[12px] w-full ">
      {data.value}
      ...
      <div className="bg-zinc-700 flex pl-3 pr-1  historyButton z-[9999]	">
        <CopyToClipboard text={`https://chatgptclonefront.onrender.com/c/${data['_id']}`}
          onCopy={() => onshare()}>
